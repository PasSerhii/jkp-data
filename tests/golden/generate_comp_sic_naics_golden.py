...
# Panel end: the latest datadate among the fixture inputs. Keep in sync with
# GOLDEN_END in tests/unit/test_comp_sic_naics.py.
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        comp_sic_naics(paths, end_date=GOLDEN_END)
